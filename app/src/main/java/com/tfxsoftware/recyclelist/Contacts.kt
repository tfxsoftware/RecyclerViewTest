...
class Contacts() : Serializable {
        var list = listOf<ContactEntry>(
            ...
            ContactEntry("Danilo", "19864634345"),
            ContactEntry("Erasmo", "782243433"),
            ContactEntry("Fabio", "178151646851"),
            ContactEntry("Gabrielle", "58687425"),
            ContactEntry("Henrique", "786556135"),
            ContactEntry("Iara", "1231231234"),
            ContactEntry("Jose", "454653223"),
